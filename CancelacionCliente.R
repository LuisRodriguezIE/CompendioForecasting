...
# https://www.youtube.com/watch?v=adG-9Jk3QbQ&index=94&list=PLNeOBuHe1dOKvuS1H7cWgiN5Ev1lJ3soy&t=0s
...
rm(list=ls()) 
setwd("C:/Users/lr_29/Desktop/Big Data Goal/R/Proyectos R Studio/ChurnAnalysis")
